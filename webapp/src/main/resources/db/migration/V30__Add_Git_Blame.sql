create table git_blame (id bigint not null auto_increment, created_date datetime, last_modified_date datetime, author_email varchar(255), author_name varchar(255), commit_name varchar(255), commit_time varchar(255), pull_request_id varchar(255), tm_text_unit_id bigint not null, primary key (id));
